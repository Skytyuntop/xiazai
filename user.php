...
<a style="color:red;">请熟记本平台永久网址<i class="layui-icon layui-icon-next"></i><i class="layui-icon layui-icon-next"></i><a href="<?=$config['siteurl']?>" target="_blank"><font color=blue><b><?=get_host()?></b></a></font></font></div>
